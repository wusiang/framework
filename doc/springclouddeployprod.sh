...
start_application(){
    ...
    echo "部署路径:${APP_HOME}";
    IMAGE_NAME="${APPLICATION_NAME}-image-prod";
    SERVER_NAME="${APPLICATION_NAME}-server-prod";
    mkdir -p ${APP_HOME}
    ...
    -e nacos.addr=172.24.40.126:8848 \
    -e nacos.discovery.group=DEFAULT_GROUP \
    -e nacos.config.group=DEFAULT_GROUP \
    -e nacos.namespace=e451dfb2-99c3-44b0-a423-d8afb9eafff3 \
    -e JAVA_OPTS="$JAVA_OPTS -Dnacos.addr=172.24.40.126:8848 -Dnacos.discovery.group=DEFAULT_GROUP -Dnacos.config.group=DEFAULT_GROUP -Dnacos.namespace=e451dfb2-99c3-44b0-a423-d8afb9eafff3" \
