...
start_application(){
    ...
    echo "部署路径:${APP_HOME}";
    IMAGE_NAME="${APPLICATION_NAME}-image-pre";
    SERVER_NAME="${APPLICATION_NAME}-server-pre";
    mkdir -p ${APP_HOME}
    ...
    -e nacos.addr=172.23.250.7:8848 \
    -e nacos.discovery.group=DEFAULT_GROUP \
    -e nacos.config.group=DEFAULT_GROUP \
    -e nacos.namespace=a19ad8da-3467-457a-922d-4740e43720a9 \
    -e JAVA_OPTS="$JAVA_OPTS -Dnacos.addr=172.23.250.7:8848 -Dnacos.discovery.group=DEFAULT_GROUP -Dnacos.config.group=DEFAULT_GROUP -Dnacos.namespace=a19ad8da-3467-457a-922d-4740e43720a9" \
