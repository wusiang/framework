...
public enum GeoTypeEnum {
	...
	WGS84("WGS84", "地球坐标系，国际通用坐标系") {
		...
		public GeoPoint toGCJ02(double lon, double lat) {
			return GeoUtils.wgs84ToGcj02(lon, lat);
		}

		@Override
		public GeoPoint toBD09(double lon, double lat) {
			return GeoUtils.wgs84ToBd09(lon, lat);
		}
	},
	GCJ02("GCJ02", "火星坐标系，高德、腾讯、阿里等使用") {
		@Override
		public GeoPoint toWGS84(double lon, double lat) {
			return GeoUtils.gcj02ToWgs84(lon, lat);
		}
		...
		@Override
		public GeoPoint toBD09(double lon, double lat) {
			return GeoUtils.gcj02ToBd09(lon, lat);
		}
	},
	BD09("BD09", "百度坐标系，百度、搜狗等使用") {
		@Override
		public GeoPoint toWGS84(double lon, double lat) {
			return GeoUtils.bd09toWgs84(lon, lat);
		}

		@Override
		public GeoPoint toGCJ02(double lon, double lat) {
			return GeoUtils.bd09ToGcj02(lon, lat);
		}
