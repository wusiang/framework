package com.xianmao.common.core.money;
...
public class Money implements Serializable, Comparable<Money> {
     ...
     * @param cent 金额分数。
     */
    public static Money of(long yuan, int cent) {
     ...
     * @param cent 金额分数。
     */
    public static Money of(long yuan, int cent, Currency currency) {
        return new Money(yuan, cent, currency);
    }
     ...
     */
    public static Money of(String amount, Currency currency, int roundingMode) {
     ...
     * @param currency
     */
    public static Money of(long cent, Currency currency) {
     ...
     * @param roundingMode 取整模式
     */
    public static Money of(BigDecimal amount, int roundingMode) {
        return new Money(amount, roundingMode);
    }
     ...
     * @param roundingMode 取整模式。
     */
    public static Money of(BigDecimal amount, Currency currency, int roundingMode) {
        return new Money(amount, currency, roundingMode);
    }
     ...
     * @return
     */
    public boolean greaterThanAndEqual(Money other) {
        return compareTo(other) >= 0;
    }
     ...
     * @return
     */
    public boolean lessThanAndEqual(Money other) {
        return other.compareTo(this) >= 0;
    }
