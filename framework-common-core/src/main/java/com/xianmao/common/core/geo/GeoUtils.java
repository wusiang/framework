...
public class GeoUtils {
	 ...
	 * 根据经纬度计算两点之间的距离 (m)
	 *
	 * @param startPoint 位置 1 的经纬度
	 * @param endPoint 位置 1 的经纬度
	 * @return 返回距离
	 */
	public static double getDistance(GeoPoint startPoint, GeoPoint endPoint) {
		return getDistance(startPoint.getLon(), startPoint.getLat(), endPoint.getLon(), endPoint.getLat());
	}
	/**
	 * 根据经纬度计算两点之间的距离 (m)
	 *
