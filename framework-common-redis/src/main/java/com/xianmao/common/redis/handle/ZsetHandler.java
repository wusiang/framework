...
public final class ZsetHandler implements RedisHandler {
     ...
     * @return 返回对象字典
     */
    public Map<Double, Object> rangeByScoreWithScoresAsObj(String key, Double min, Double max, Long count,
        Long offset) {
     ...
     * @return 返回对象集合
     */
    public Map<Double, Object> reverseRangeByScoreWithScoresAsObj(String key, Double min, Double max, Long count,
        Long offset) {
     ...
     * @return 返回字符串集合
     */
    public Map<Double, String> reverseRangeByScoreWithScores(String key, Double min, Double max, Long count,
        Long offset) {
     ...
     * @return 返回范围对象
     */
    private Range<String> getRange(Long startSortIndex, boolean isContainsStart, Long endSortIndex,
                                         boolean isContainsEnd) {
